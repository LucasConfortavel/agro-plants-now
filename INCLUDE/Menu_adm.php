...
<body>
    ...
    <aside class="jp_sidebar">
        ...
        <div class="jp_bottom-menu">
            <ul>
                <button onclick= "window.location.href='../../VIEW/adm/ajustes-informacoes-adm.php'"><li id="ajustes"><img src="https://raw.githubusercontent.com/feathericons/feather/master/icons/settings.svg" alt=""> Ajustes</li></button>
