<?php
class AjustesView {
    public function exibirPaginaAjustes($user_data, $alerta = '') {
        ?>
        <!DOCTYPE html>
        <html lang="pt-BR">
        <head>
            ...
            <main class="jp_main-content">
                ...
                <div class="tab-content active" id="personal">
                    <div class="content-card">
                        ...
                        <form id="personalForm" class="form-grid" method="POST" action="ajustes-informacoes-adm.php?action=atualizarInformacoes">
                ...
                <div class="tab-content" id="security">
                    <div class="content-card">
                        ...
                        <div class="security-section">
                            <h4>Alterar Senha</h4>
                            <form id="passwordForm" class="password-form" method="POST" action="ajustes-informacoes-adm.php?action=alterarSenha">
                        ...
                        <div class="notification-section">
                            ...
                            <div class="notification-item">
                                <div class="notification-info">
                                    ...
                                    <span>Receba notificações sobre atualizações importantes</span>
                                </div>
