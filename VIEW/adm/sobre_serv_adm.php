        ...
        <section class="gs_product-container">
            ...
            <div class="gs_area-img">
                <div class="gs_main-image-wrapper">
                    <img src="../../PUBLIC/img/img_servico.webp" alt="Herbicida Glifosato" class="gs_product-image" id="mainImage">
            ...
            <div class="gs_product-info">
                <div class="gs_header-section">
                    ...
                    <h1 class="gs_product-title">Análise de Água para irrigação</h1>
                </div>
                ...
                <div class="gs_info-grid">
                    <div class="gs_info-card">
                        ...
                        <div class="gs_info-content">
                            ...
                            <p class="gs_value">Análises Laboratoriais</p>
                        </div>
                    </div>
                    ...
                    <div class="gs_info-card gs_price-card">
                        ...
                        <div class="gs_info-content">
                            ...
                            <p class="gs_value gs_price">R$ 300,00</p>
                        </div>
                    </div>
                ...
                <div class="gs_description-section">
                    ...
                    <p class="gs_description-text">Exame da qualidade da água utilizada na irrigação</p>
                </div>
