    ...
    <section class="ym_area-pop-up">
        <div class="ym_pop-up">
            <div class="ym_superior-pop-up">
                ...
                <button class="ym_btn-pop-up" style="margin-bottom: 20px;"><img clas="ym_img-icons" src="/projeto_agro_plants_now1/PUBLIC/img/fecha.png" alt=""></button>
            </div>
            
            <div class="ym_inferior-pop-up">
                <p id="ym_link"><?php echo $link; ?></p>
                <button onclick="copiarLink()" class='ym_btn-pop-up'><img clas="ym_img-icons" src="/projeto_agro_plants_now1/PUBLIC/img/copiar.png" alt=""></button>
            </div>
